...
int main(){
	...
	memset(play2_bowls, '\0', 336);
	memset(play3_bowls, '\0', 336);
	memset(play4_bowls, '\0', 336);
	memset(play5_bowls, '\0', 336);
	memset(play1_tot, '\0', 336);
	memset(play2_tot, '\0', 336);
	memset(play3_tot, '\0', 336);
	memset(play4_tot, '\0', 336);
	memset(play5_tot, '\0', 336);
...
void display (int players, int round, int play1_bowls[], int play2_bowls[], int play3_bowls[], int play4_bowls[], int play5_bowls[], int play1_tot[], int play2_tot[], int play3_tot[], int play4_tot[], int play5_tot[], char play1_name[], char play2_name[], char play3_name[], char play4_name[], char play5_name[]){
	...
	switch(i){
		...
		for(int i=0; i<9; i++)
			...
			cout<<endl;
		for(int i=0; i<9; i++)
			cout<<" | "<<play1_tot[2*i]<<"  "<<play1_tot[2*i+1]<<" | ";	
			cout<<endl;
		break;
	case 2:
//player 2
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		...
		for(int i=0; i<9; i++)
			...
			cout<<endl;
		for(int i=0; i<9; i++)
			cout<<" | "<<play2_tot[2*i]<<"  "<<play2_tot[2*i+1]<<" | ";	
			cout<<endl;
...
//player 3
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		...
		for(int i=0; i<9; i++)
			...
			cout<<endl;
		for(int i=0; i<9; i++)
			cout<<" | "<<play3_tot[2*i]<<"  "<<play3_tot[2*i+1]<<" | ";	
			cout<<endl;
...
//player 4
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		...
		for(int i=0; i<9; i++){
			...
			cout<<endl;
		for(int i=0; i<9; i++)
			cout<<" | "<<play4_tot[2*i]<<"  "<<play4_tot[2*i+1]<<" | ";	
			cout<<endl;
...
//player 5
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		...
		for(int i=0; i<9; i++)
			...
			cout<<endl;
		for(int i=0; i<9; i++)
			cout<<" | "<<play5_tot[2*i]<<"  "<<play5_tot[2*i+1]<<" | ";	
			cout<<endl;
	break;
		}
	}
...
int dismath(int round, int* playerbowls

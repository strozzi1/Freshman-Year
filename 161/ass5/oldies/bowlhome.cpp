...
int posifunk(int, char*, int*, int*, int);
...
void display (int players, int round, int play1_bowls[], int play2_bowls[], int play3_bowls[], int play4_bowls[], int play5_bowls[], int play1_tot[], int play2_tot[], int play3_tot[], int play4_tot[], int play5_tot[], char play1_name[], char play2_name[], char play3_name[], char play4_name[], char play5_name[]){
	...
	switch(i){
		...
		case 1:
			posifunk(i,play1_name,play1_bowls, play1_tot, round);
/***
		cout<<play1_name<<endl;
		for(int i=0; i<9; i++){
			dismath(i, play1_bowls, play1_tot);
		//	cout<<" | "<<play1_bowls[2*i]<<"  "<<play1_bowls[2*i+1]<<" | ";
		}
			frame10(round, play1_bowls, play1_tot);
			//cout<<"asdflasdfl";
			cout<<endl;
		for(int i=0; i<9; i++){
...
//player 2
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		posifunk(i,play2_name,play2_bowls, play2_tot, round);
		
	break;
	case 3:
//player 3
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		posifunk(i,play3_name,play3_bowls, play3_tot, round);
...
//player 4
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		posifunk(i,play4_name,play4_bowls, play4_tot, round);

	break;
	case 5:
//player 5
	cout<< "--------------------------------------------------------------------------------------"<<endl;
		posifunk(i,play5_name,play5_bowls, play5_tot, round);
...
int posifunk(int i, char* playername, int* playerbowls, int* playertot, int round){
